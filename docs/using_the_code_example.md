...
The following example clones the "[EPC2 TF-M Crypto](https://github.com/Infineon/mtb-example-psoc-edge-epc2-tfm-crypto)" application with the desired name "Epc2TfmCrypto" configured for the *KIT_PSE84_EVAL_EPC2* BSP into the specified working directory, *C:/mtb_projects*:

   ```
   project-creator-cli --board-id KIT_PSE84_EVAL_EPC2 --app-id mtb-example-psoc-edge-epc2-tfm-crypto --user-app-name Epc2TfmCrypto --target-dir "C:/mtb_projects"
   ```
