...
/* CM55 user image */
    #define IFX_CM55_NS_CODE_START      (IFX_CM55_NS_IMAGE_EXECUTE_ADDR + IFX_UNSIGNED_TO_VALUE(BL2_HEADER_SIZE))
    #define IFX_CM55_NS_CODE_SIZE       (IFX_CM55_NS_IMAGE_EXECUTE_SIZE - IFX_UNSIGNED_TO_VALUE(BL2_HEADER_SIZE) - \
                                                                          IFX_UNSIGNED_TO_VALUE(BL2_TRAILER_SIZE))
