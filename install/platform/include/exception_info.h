...
#ifdef PLATFORM_EXCEPTION_INFO
/**
 * \brief This function store and/or dump the platform-specific exception info.
 *
...
#else  /* PLATFORM_EXCEPTION_INFO */
#define PLATFORM_EXCEPTION_INFO_CALL()
/* Declaration of required symbols for IAR inline assembler */
#define PLATFORM_EXCEPTION_INFO_IAR_REQUIRED
#endif /* PLATFORM_EXCEPTION_INFO */
