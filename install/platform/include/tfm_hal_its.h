/*
 * Copyright (c) 2020-2025 Cypress Semiconductor Corporation. All rights reserved.
...
#ifndef TFM_HAL_ITS_H
#define TFM_HAL_ITS_H
...
#if !ITS_RAM_FS && !defined(TFM_HAL_ITS_FLASH_DRIVER)
...
/* Custom flash driver for ITS is defined through
 * TFM_HAL_ITS_FLASH_OPS - `const struct its_flash_ops_t` implementation of
 *      ITS flash operations
 * TFM_HAL_ITS_FLASH_DRIVER - this variable is assigned to
 *      \ref its_flash_config_t.context of ITS flash driver instance configuration.
 * TFM_HAL_ITS_FLASH_DRIVER_TYPE - type of \ref TFM_HAL_ITS_FLASH_DRIVER
 */
#ifndef TFM_HAL_ITS_FLASH_DRIVER_TYPE
#error "TFM_HAL_ITS_FLASH_DRIVER_TYPE must be defined for custom TFM_HAL_ITS_FLASH_OPS"
#endif
extern TFM_HAL_ITS_FLASH_DRIVER_TYPE TFM_HAL_ITS_FLASH_DRIVER;
extern const struct its_flash_ops_t TFM_HAL_ITS_FLASH_OPS;
