...
set(IFX_BSP_DEVICE_SUPPORT_LIBS             F:/mtb_shared/ifx-tf-m-pse84epc2/release-v2.1.400/src/platform/ext/target/infineon/pse84/../common/deploy/mtb-personalities/props.json CACHE STRING "List of additional device support libraries")

#################################### IFX #######################################

set(IFX_CM33_NS_PRESENT                     ON CACHE BOOL      "Enable CM33 NSPE for IFX platform" FORCE)
set(IFX_CM55_NS_PRESENT                     ON CACHE BOOL      "Enable CM55 NSPE for IFX platform" FORCE)

# CM55 core needs to be halted for debugging
set(IFX_HALT_CM55                           OFF         CACHE BOOL      "Whether to halt CM55 core after reset")

set(IFX_MTB_MAILBOX                         ON     CACHE BOOL      "Whether to use Infineon MTB mailbox implementation")
...
set(IFX_USE_SW_SHA                           CACHE BOOL      "Whether to compute SHA256 by software implementation")
