                                ...
                                uintptr_t second_region_limit)
{
    ...
    /* Return the result */
    return (first_region_start >= second_region_start) && (first_region_limit <= second_region_limit);
}
                                 ...
                                 uintptr_t second_region_limit)
{
    ...
    /* Return the result */
    return (first_region_start <= second_region_limit) && (first_region_limit >= second_region_start);
}
