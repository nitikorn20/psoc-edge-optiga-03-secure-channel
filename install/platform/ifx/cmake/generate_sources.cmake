...
function(ifx_generate_sources)
    ...
    if(NOT IFX_MTB_BUILD)
        ...
        if(DEFINED IFX_DEV_SUPPORT_LIB_PATH AND EXISTS ${IFX_DEV_SUPPORT_LIB_PATH})
            list(APPEND IFX_BSP_DEVICE_SUPPORT_LIBRARIES_LIST "${IFX_DEV_SUPPORT_LIB_PATH}/props.json")
        else()
        ...
        string(REPLACE ";" "," IFX_BSP_DEVICE_SUPPORT_LIBRARIES "${IFX_BSP_DEVICE_SUPPORT_LIBRARIES_LIST}")
