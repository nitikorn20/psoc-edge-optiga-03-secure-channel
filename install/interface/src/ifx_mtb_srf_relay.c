    ...
    case MAILBOX_PSA_CALL:
        ...
        for (size_t i = 0; i < in_len; i++) {
            ...
            if (params->psa_params.psa_call_params.in_vec[i].base == NULL) {
                ...
                in_vec[i].base = tfm_hal_remap_ns_cpu_address(params->psa_params.psa_call_params.in_vec[i].base);
            }
        ...
        for (size_t i = 0; i < out_len; i++) {
            ...
            if (params->psa_params.psa_call_params.out_vec[i].base == NULL) {
                ...
                out_vec[i].base = tfm_hal_remap_ns_cpu_address(params->psa_params.psa_call_params.out_vec[i].base);
            }
