...
/**
 * \brief             Get the resumption state of given ssl context.
 *
 * \param ssl         The SSL connection instance.
 *
 * \return            ssl resumption state on success. An SSL specific error on failure.
 */
int mbedtls_ssl_get_resumption_state(mbedtls_ssl_context *ssl);
