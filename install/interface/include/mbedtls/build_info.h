...
/* Setup specific mbedtls configuration for Infineon platforms */
#ifdef COMPONENT_MW_IFX_MBEDTLS
#include "target/infineon/mbedtls/infineon_platform.h"
#else
#include "mbedtls/mbedtls_config.h"
#endif /* COMPONENT_MW_IFX_MBEDTLS */
#else
